...
export const NEW: Row[] = [
  ...
  { title: 'Pilgrim Trust — Historic Buildings and Structures', funder: 'The Pilgrim Trust', funder_type: 'trust_foundation',
  ...
  { title: 'Pilgrim Trust — Conservation of Cultural Heritage', funder: 'The Pilgrim Trust', funder_type: 'trust_foundation',
    funding_type: 'grant', funding_subtypes: ['project'],
  ...
  { title: 'Vinehill Trust — Health', funder: 'The Vinehill Trust', funder_type: 'trust_foundation',
    ...
    impact_sectors: ['health', 'environment', 'older_people'], target_beneficiaries: ['people_in_poverty', 'disabled_people', 'rural_communities'],
  ...
  { title: 'David Riddell Memorial CIO — Suicide Prevention Grants 2026/27', funder: 'David Riddell Memorial CIO', funder_type: 'trust_foundation',
    ...
    impact_sectors: ['mental_health', 'health'], target_beneficiaries: ['mental_health'],
    niche_tags: [],
