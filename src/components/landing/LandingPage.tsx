        ...
        <div className="relative z-10 mx-auto max-w-7xl px-8 flex flex-col lg:flex-row items-center gap-12 lg:gap-16" style={{ minHeight: '100vh', paddingTop: '120px', paddingBottom: '80px' }}>
          ...
          <div className="flex-1 max-w-xl lg:pl-12">
            ...
            <motion.div {...fadeUp(0.3)} className="flex flex-wrap gap-3 mb-14">
              <Link href="/auth/signup" className="bg-coral text-white rounded-xl px-6 py-3 text-[15px] font-semibold hover:opacity-90 transition-colors">
                Start for free
              </Link>
              <a href="#how" className="border border-coral/50 text-coral rounded-xl px-6 py-3 text-[15px] font-semibold transition-colors hover:bg-coral/10">
                See how it works
              </a>
            </motion.div>
