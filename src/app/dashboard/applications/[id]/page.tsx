        ...
        <div style={{
          ...
          <p style={{ fontFamily: BODY, fontSize: 13.5, color: T.textSecondary, margin: '0 auto 16px', lineHeight: 1.6, maxWidth: 460 }}>
            {generating
              ...
              : blockCount === 0
                ? 'You have no saved material yet, so answer plans and drafts will be mostly gaps. Import a past application first (in the &#8943; menu above) and we&apos;ll work from your real material.' /* eslint-disable-line no-restricted-syntax -- alpha-suffixed hex colour, excluded from the mechanical sweep */
