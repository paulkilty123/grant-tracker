    ...
    <div className="max-w-6xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {[
          ...
          { label: 'Errors', value: errorCount, colour: errorCount > 0 ? 'text-red-600' : 'text-mid' },
            ...
            >
              <div className="flex items-start gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  {entry.last_error && (
                    <p className="text-[10px] text-red-500 mt-0.5 truncate">{entry.last_error}</p>
                  )}
                </div>
                ...
                <div className="space-y-3 max-h-[500px] overflow-y-auto">
                  {alerts.map(alert => (
                    ...
                    >
                      ...
                      {alert.alert_type === 'page_down' && (
                        <p className="text-[10px] text-red-700">{alert.snapshot_after}</p>
                      )}
                      {alert.resolved && (
