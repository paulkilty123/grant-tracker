    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#FAFAF7' }}>
        <div className="bg-white rounded-3xl max-w-md w-full p-10 text-center" style={{ boxShadow: '0 8px 40px rgba(0,0,0,0.08)' }}>
          <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-6" style={{ background: '#F1F7E4' }}>
            <Bell size={24} style={{ color: '#8ECB3C' }} />
          </div>
          <h2 className="mb-2 font-bold" style={{ fontFamily: 'var(--font-space-grotesk)', fontSize: '1.5rem', color: '#2C2C2A', letterSpacing: '-0.02em' }}>Check your email</h2>
          <p className="text-sm leading-relaxed mb-1" style={{ color: '#5F5E5A' }}>
            We&apos;ve sent a confirmation link to <strong style={{ color: '#2C2C2A' }}>{email}</strong>. Click it to activate your account.
          </p>
          <p className="text-xs mb-5" style={{ color: '#8A8986' }}>Can&apos;t find it? Check your spam folder.</p>
          <div className="mb-6">
            {resent ? (
              <p className="text-xs font-medium" style={{ color: '#8ECB3C' }}>&#10003; Confirmation email resent</p>
            ) : (
              <button
          ...
          <div className="pt-5 border-t space-y-2" style={{ borderColor: '#F0F0F0' }}>
            <p className="text-xs font-semibold" style={{ color: '#2C2C2A', fontFamily: 'var(--font-space-grotesk)' }}>While you wait, here&apos;s what happens next:</p>
            <ol className="text-xs text-left space-y-1 list-decimal list-inside" style={{ color: '#5F5E5A' }}>
            ...
            <div className="pt-3">
              <Link href="/auth/login" className="text-xs hover:underline" style={{ color: '#8ECB3C' }}>
      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 overflow-hidden rounded-3xl" style={{ boxShadow: '0 8px 48px rgba(0,0,0,0.10)' }}>
          ...
          <div className="bg-white p-8 lg:p-10 flex flex-col justify-center">
            ...
            <p className="text-xs mb-4 lg:hidden" style={{ color: '#8A8986' }}>Search 500+ grants &middot; AI-matched to your mission &middot; Free to start</p>
            <h1 className="font-bold leading-tight mb-1" style={{ fontFamily: 'var(--font-space-grotesk)', fontSize: 'clamp(22px, 3vw, 28px)', letterSpacing: '-0.02em', color: '#2C2C2A' }}>Create your free account</h1>
            <p className="text-sm mb-7" style={{ color: '#8A8986' }}>Takes 30 seconds &mdash; no credit card needed</p>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-semibold mb-1.5" style={{ color: '#2C2C2A', fontFamily: 'var(--font-space-grotesk)' }}>Your name</label>
              ...
              <div>
                <label className="block text-sm font-semibold mb-1.5" style={{ color: '#2C2C2A', fontFamily: 'var(--font-space-grotesk)' }}>Password</label>
                ...
                {password.length > 0 && (
                  <p className="text-xs mt-1.5" style={{ color: pwStrong ? '#8ECB3C' : '#BA7517' }}>
            ...
            <div className="flex items-center justify-center gap-1.5 mt-5 lg:hidden">
              <Lock size={11} style={{ color: '#8A8986' }} />
              <p className="text-xs" style={{ color: '#8A8986' }}>Your data is never shared</p>
            </div>
            <div className="mt-6 pt-6 text-center" style={{ borderTop: '1px solid #F0F0F0' }}>
              <p className="text-sm" style={{ color: '#8A8986' }}>
                Already have an account?{' '}
                <Link href="/auth/login" className="font-semibold hover:underline" style={{ color: '#8ECB3C' }}>Sign in</Link>
              </p>
            </div>
          </div>
