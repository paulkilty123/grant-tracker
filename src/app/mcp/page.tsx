    ...
    <div style={{ background: '#FAFAF7', minHeight: '100vh', fontFamily: 'var(--font-plus-jakarta, Plus Jakarta Sans, sans-serif)', color: '#2C2C2A' }}>
      ...
      <main style={{ maxWidth: 760, margin: '0 auto', padding: '64px 32px 48px' }}>
        ...
        <section id="connect" style={{ borderTop: '0.5px solid rgba(23,52,4,0.08)', paddingTop: 32, marginBottom: 36 }}>
          ...
          <pre style={{ background: '#F1F7E4', border: '0.5px solid rgba(23,52,4,0.12)', borderRadius: 8, padding: '12px 14px', fontSize: 13, color: '#173404', overflowX: 'auto', margin: '0 0 12px' }}>{`${brand.siteUrl}/api/mcp/v1/mcp`}</pre>
        ...
        <div style={{ borderTop: '0.5px solid rgba(23,52,4,0.08)', paddingTop: 24, fontSize: 13, color: '#8A8986', lineHeight: 1.6 }}>
          The MCP is read-only. Saving opportunities, deadline alerts, pipeline tracking, and personalised matching against your organisation&apos;s profile all happen in the <Link href="/" style={{ color: '#3B6D11', fontWeight: 600, textDecoration: 'none' }}>{brand.name} web app</Link>.
        </div>
      </main>
    </div>
  )
