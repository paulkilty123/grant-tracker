      ...
      <main style={{ maxWidth: 900, margin: '0 auto', padding: '48px 32px' }}>
        <div className="flex items-start justify-between mb-6 gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-mid">
              Keys for connecting MCP-compatible agents (Claude, ChatGPT, Gemini, others) to the {brand.name} funding catalogue.
            </p>
          </div>
          <Link
            href="/mcp/keys/new"
        ...
        {keys.length === 0 ? (
          <div className="rounded-xl border border-warm p-10 text-center" style={{ background: 'white' }}>
            ...
            <p className="text-xs text-mid mb-4">Generate your first key to connect an agent to the {brand.mcp.productName}.</p>
            <Link
              href="/mcp/keys/new"
