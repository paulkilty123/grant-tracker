...
export const metadata = {
  title: `Apply to join the founding cohort — ${brand.name}`,
  description: `Join the ${brand.name} founding cohort. Around 20–30 organisations who help shape the product and get free access during beta.`,
}
          ...
          <div style={{ background: 'white', border: '0.5px solid rgba(23,52,4,0.08)', borderRadius: 14, padding: '40px 36px' }}>
            ...
            <div style={{ margin: '0 -4px' }}>
              <iframe
                ...
                marginHeight={0}
                marginWidth={0}
                title={`Apply to the ${brand.name} founding cohort`}
                style={{ display: 'block' }}
              />
            </div>
            <Script
          ...
          {[
            {
              ...
              a: `June 2026. The cohort runs until then, giving us time to iterate on the product based on real use before ${brand.name} opens to everyone. Cohort members keep their founding benefits regardless of when paid signups open to the wider public.`,
            },
            {
            ...
            },
            {
              ...
              a: `You will. I commit to replying to every application, usually within a week. If it’s been longer, please email me directly at ${brand.email.hello}.`,
            },
            {
