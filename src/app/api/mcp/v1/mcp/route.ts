...
const MCP_SERVER_INFO = {
  ...
  icons: [
    ...
    { src: 'https://www.granttracker.co.uk/android-chrome-512x512.png', mimeType: 'image/png', sizes: ['512x512'] },
  ],
}
